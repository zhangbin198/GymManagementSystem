 ...
 * @date 2022/7/20 6:26
 */
@WebServlet("/GymEquipmentEditServlets.do")
public class GymEquipmentEditServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        equipment.setEquipmentId(Integer.parseInt(equipmentId));
        ...
        int i = equipments.editEquipment(equipment);
        //判断是否更新成功
        if (i == 1) {
